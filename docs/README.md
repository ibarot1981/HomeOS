...
- Alert output: received SmartElex Passive Buzzer Module; wiring remains pending vendor confirmation because its PCB labels differ from the supplied generic reference
